...
export const navItems: NavItem[] = [
  ...
  { id: 'neurohack', label: 'Neurohack', icon: 'zap', path: '/neurohack', badge: 'APEX' },
  { id: 'adventure', label: 'Adventure', icon: 'zap', path: '/adventure', badge: 'LVL' },
...
export const systemStatusItems = [
  ...
  { id: 'neurohack', label: 'Neurohack', status: 'active' as const },
